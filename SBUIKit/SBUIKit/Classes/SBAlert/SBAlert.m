...
typedef NS_ENUM(NSInteger, SBBackgroundStyle) {
    /** 背景样式 模糊 */
    SBBackgroundStyleBlur,
    /** 背景样式 半透明 */
    SBBackgroundStyleTranslucent,
};

@interface SBAlertConfigModel ()
...
@property (nonatomic , copy ) CGFloat (^modelMaxWidthBlock)(SBScreenOrientationType);
@property (nonatomic , copy ) CGFloat (^modelMaxHeightBlock)(SBScreenOrientationType);
...
@property (nonatomic , assign ) SBBackgroundStyle modelBackgroundStyle;
@property (nonatomic , assign ) SBAnimationStyle modelOpenAnimationStyle;
@property (nonatomic , assign ) SBAnimationStyle modelCloseAnimationStyle;
...
@implementation SBAlertConfigModel
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _modelBackgroundStyle = SBBackgroundStyleTranslucent; //默认为半透明背景样式
...
- (SBAlertConfigBlockToString)sbTitle{
    
    return ^(NSString *str){
        
        return self.sbAddTitle(^(UILabel *label) {
...
- (SBAlertConfigBlockToString)sbContent{
    
    return ^(NSString *str){
        
        return  self.sbAddContent(^(UILabel *label) {
...
- (SBAlertConfigBlockToView)sbCustomView{
    
    return ^(UIView *view){
        
        return self.sbAddCustomView(^(SBCustomView *custom) {
...
- (SBAlertConfigBlockToStringAndBlock)sbAction{
    
    return ^(NSString *title , void(^block)(void)){
        
        return self.sbAddAction(^(SBAction *action) {
            
            action.type = SBActionTypeDefault;
...
- (SBAlertConfigBlockToStringAndBlock)sbCancelAction{
    
    return ^(NSString *title , void(^block)(void)){
        
        return self.sbAddAction(^(SBAction *action) {
            
            action.type = SBActionTypeCancel;
...
- (SBAlertConfigBlockToStringAndBlock)sbDestructiveAction{
    
    return ^(NSString *title , void(^block)(void)){
        
        return self.sbAddAction(^(SBAction *action) {
            
            action.type = SBActionTypeDestructive;
...
- (SBAlertConfigBlockToConfigLabel)sbAddTitle{
    
    return ^(void(^block)(UILabel *)){
        
        return self.sbAddItem(^(SBItem *item) {
            
            item.type = SBItemTypeTitle;
...
- (SBAlertConfigBlockToConfigLabel)sbAddContent{
    
    return ^(void(^block)(UILabel *)){
        
        return self.sbAddItem(^(SBItem *item) {
            
            item.type = SBItemTypeContent;
...
- (SBAlertConfigBlockToCustomView)sbAddCustomView{
    
    return ^(void(^block)(SBCustomView *custom)){
        
        return self.sbAddItem(^(SBItem *item) {
            
            item.type = SBItemTypeCustomView;
...
- (SBAlertConfigBlockToItem)sbAddItem{
    
    return ^(void(^block)(SBItem *)){
...
- (SBAlertConfigBlockToAction)sbAddAction{
    
    return ^(void(^block)(SBAction *)){
...
- (SBAlertConfigBlockToEdgeInsets)sbHeaderInsets{
...
- (SBAlertConfigBlockToEdgeInsets)sbItemInsets{
...
- (SBAlertConfigBlockToFloat)sbMaxWidth{
    
    return ^(CGFloat number){
        
        return self.sbConfigMaxWidth(^CGFloat(SBScreenOrientationType type) {
...
- (SBAlertConfigBlockToFloat)sbMaxHeight{
    
    return ^(CGFloat number){
        
        return self.sbConfigMaxHeight(^CGFloat(SBScreenOrientationType type) {
...
- (SBAlertConfigBlockToFloatBlock)sbConfigMaxWidth{
    
    return ^(CGFloat(^block)(SBScreenOrientationType type)){
...
- (SBAlertConfigBlockToFloatBlock)sbConfigMaxHeight{
...
- (SBAlertConfigBlockToFloat)sbCornerRadius{
...
- (SBAlertConfigBlockToFloat)sbOpenAnimationDuration{
...
- (SBAlertConfigBlockToFloat)sbCloseAnimationDuration{
...
- (SBAlertConfigBlockToColor)sbHeaderColor{
...
- (SBAlertConfigBlockToColor)sbBackGroundColor{
...
- (SBAlertConfigBlockToFloat)sbBackgroundStyleTranslucent{
    
    return ^(CGFloat number){
        
        self.modelBackgroundStyle = SBBackgroundStyleTranslucent;
...
- (SBAlertConfigBlockToBlurEffectStyle)sbBackgroundStyleBlur{
    
    return ^(UIBlurEffectStyle style){
        
        self.modelBackgroundStyle = SBBackgroundStyleBlur;
...
- (SBAlertConfigBlockToBool)sbClickHeaderClose{
...
- (SBAlertConfigBlockToBool)sbClickBackgroundClose{
...
- (SBAlertConfigBlockToSize)sbShadowOffset{
...
- (SBAlertConfigBlockToFloat)sbShadowOpacity{
...
- (SBAlertConfigBlockToFloat)sbShadowRadius{
...
- (SBAlertConfigBlockToColor)sbShadowColor{
...
- (SBAlertConfigBlockToString)sbIdentifier{
...
- (SBAlertConfigBlockToBool)sbQueue{
...
- (SBAlertConfigBlockToInteger)sbPriority{
...
- (SBAlertConfigBlockToBool)sbContinueQueueDisplay{
...
- (SBAlertConfigBlockToFloat)sbWindowLevel{
...
- (SBAlertConfigBlockToBool)sbShouldAutorotate{
...
- (SBAlertConfigBlockToInterfaceOrientationMask)sbSupportedInterfaceOrientations{
...
- (SBAlertConfigBlockToBlockAndBlock)sbOpenAnimationConfig{
...
- (SBAlertConfigBlockToBlockAndBlock)sbCloseAnimationConfig{
...
- (SBAlertConfigBlockToAnimationStyle)sbOpenAnimationStyle{
    
    return ^(SBAnimationStyle style){
...
- (SBAlertConfigBlockToAnimationStyle)sbCloseAnimationStyle{
...
- (SBAlertConfigBlockToStatusBarStyle)sbStatusBarStyle{
...
- (SBAlertConfigBlockToConfigTextField)sbAddTextField{
    
    return ^(void (^block)(UITextField *)){
        
        return self.sbAddItem(^(SBItem *item) {
            
            item.type = SBItemTypeTextField;
...
- (SBAlertConfigBlockToPoint)sbAlertCenterOffset {
...
- (SBAlertConfigBlockToBool)sbAvoidKeyboard{
...
- (SBAlertConfigBlockToFloat)sbActionSheetCancelActionSpaceWidth{
...
- (SBAlertConfigBlockToColor)sbActionSheetCancelActionSpaceColor{
...
- (SBAlertConfigBlockToFloat)sbActionSheetBottomMargin{
...
- (SBAlertConfigBlockToColor)sbActionSheetBackgroundColor{
...
- (SBAlertConfigBlockToBlockReturnBool)sbShouldClose{
...
- (SBAlertConfigBlockToBlockIntegerReturnBool)sbShouldActionClickClose{
...
- (SBAlertConfigBlockToBlock)sbCloseComplete{
...
@property (nonatomic , strong ) SBAlertWindow *sbWindow;

@property (nonatomic , strong ) NSMutableArray <SBAlertConfig *>*queueArray;

@property (nonatomic , strong ) SBBaseViewController *viewController;

@end

@protocol SBAlertProtocol <NSObject>

- (void)closeWithCompletionBlock:(void (^)(void))completionBlock;

@end

@implementation SBAlert

+ (SBAlert *)shareManager{
    
    static SBAlert *alertManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        
        alertManager = [[SBAlert alloc] init];
    });
...
+ (SBAlertConfig *)alert{
    ...
    SBAlertConfig *config = [[SBAlertConfig alloc] init];
    
    config.type = SBAlertTypeAlert;
    
    return config;
}

+ (SBAlertConfig *)actionsheet{
    
    SBAlertConfig *config = [[SBAlertConfig alloc] init];
    
    config.type = SBAlertTypeActionSheet;
    
    config.config.sbClickBackgroundClose(YES);
    
    return config;
}

+ (SBAlertWindow *)getAlertWindow{
    
    return [SBAlert shareManager].sbWindow;
}

+ (void)configMainWindow:(UIWindow *)window{
    
    if (window) [SBAlert shareManager].mainWindow = window;
}

+ (void)continueQueueDisplay{
    
    if ([SBAlert shareManager].queueArray.count) [SBAlert shareManager].queueArray.lastObject.config.modelFinishConfig();
}

+ (void)clearQueue{
    
    [[SBAlert shareManager].queueArray removeAllObjects];
}
...
+ (void)closeWithIdentifier:(NSString *)identifier force:(BOOL)force completionBlock:(void (^)(void))completionBlock{
    ...
    if ([SBAlert shareManager].queueArray.count) {
        
        BOOL isLast = false;
        
        NSUInteger count = [SBAlert shareManager].queueArray.count;
        
        NSMutableIndexSet *indexs = [[NSMutableIndexSet alloc] init];
        
        for (NSUInteger i = 0; i < count; i++) {
            
            SBAlertConfig *config = [SBAlert shareManager].queueArray[i];
            
            SBAlertConfigModel *model = config.config;
            
            if (model.modelIdentifier != nil && [identifier isEqualToString: model.modelIdentifier]) {
                
                if (i == count - 1 && [[SBAlert shareManager] viewController]) {
                    if (force) {
        ...
        [[SBAlert shareManager].queueArray removeObjectsAtIndexes:indexs];
        
        if (isLast) {
        
            [SBAlert closeWithCompletionBlock:completionBlock];
...
+ (void)closeWithCompletionBlock:(void (^)(void))completionBlock{
    ...
    if ([SBAlert shareManager].queueArray.count) {
        ...
        SBAlertConfig *item = [SBAlert shareManager].queueArray.lastObject;
...
- (NSMutableArray <SBAlertConfig *>*)queueArray{
...
- (SBAlertWindow *)sbWindow{
    
    if (!_sbWindow) {
        
        _sbWindow = [[SBAlertWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
        
        _sbWindow.rootViewController = [[UIViewController alloc] init];
        
        _sbWindow.backgroundColor = [UIColor clearColor];
        
        _sbWindow.windowLevel = UIWindowLevelAlert;
        
        _sbWindow.hidden = YES;
    }
...
@implementation SBAlertWindow

@end

@interface SBItem ()

@property (nonatomic , copy ) void (^updateBlock)(SBItem *);
...
@property (nonatomic , copy ) void (^updateBlock)(SBAction *);

@end

@implementation SBAction
...
+ (SBItemView *)view{
    ...
    return [[SBItemView alloc] init];
}

@end

@interface SBItemLabel : UILabel
...
@implementation SBItemLabel

+ (SBItemLabel *)label{
    
    return [[SBItemLabel alloc] init];
}
...
@interface SBItemTextField : UITextField

@property (nonatomic , strong ) SBItem *item;

+ (SBItemTextField *)textField;

@end

@implementation SBItemTextField

+ (SBItemTextField *)textField{
    
    return [[SBItemTextField alloc] init];
}
...
@property (nonatomic , strong ) SBAction *action;

@property (nonatomic , copy ) void (^heightChangedBlock)(void);

+ (SBActionButton *)button;

@end

@interface SBActionButton ()
...
+ (SBActionButton *)button{
    ...
    return [SBActionButton buttonWithType:UIButtonTypeCustom];;
}

- (void)setAction:(SBAction *)action{
    ...
    if (action.borderPosition & SBActionBorderPositionTop &&
        action.borderPosition & SBActionBorderPositionBottom &&
        action.borderPosition & SBActionBorderPositionLeft &&
        action.borderPosition & SBActionBorderPositionRight) {
        ...
        if (action.borderPosition & SBActionBorderPositionTop) [self addTopBorder]; else [self removeTopBorder];
        
        if (action.borderPosition & SBActionBorderPositionBottom) [self addBottomBorder]; else [self removeBottomBorder];
        
        if (action.borderPosition & SBActionBorderPositionLeft) [self addLeftBorder]; else [self removeLeftBorder];
        
        if (action.borderPosition & SBActionBorderPositionRight) [self addRightBorder]; else [self removeRightBorder];
    }
    
    __weak typeof(self) weakSelf = self;
    
    action.updateBlock = ^(SBAction *act) {
...
@implementation SBCustomView

- (instancetype)init
{
    self = [super init];
    if (self) {
        _positionType = SBCustomViewPositionTypeCenter;
    }
    return self;
}
...
@interface SBBaseViewController ()<UIGestureRecognizerDelegate>

@property (nonatomic , strong ) SBAlertConfigModel *config;
...
@property (nonatomic , assign ) SBScreenOrientationType orientationType;

@property (nonatomic , strong ) SBCustomView *customView;
...
- (void)viewDidLoad{
    ...
    if (self.config.modelBackgroundStyle == SBBackgroundStyleBlur) {
    ...
    self.orientationType = VIEW_HEIGHT > VIEW_WIDTH ? SBScreenOrientationTypeVertical : SBScreenOrientationTypeHorizontal;
}
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id<UIViewControllerTransitionCoordinator>)coordinator{
    ...
    self.orientationType = size.height > size.width ? SBScreenOrientationTypeVertical : SBScreenOrientationTypeHorizontal;
}
...
- (void)closeAnimationsWithCompletionBlock:(void (^)(void))completionBlock{
    ...
    [[SBAlert shareManager].sbWindow endEditing:YES];
}
...
- (UIWindow *)currentKeyWindow{
    ...
    if (!_currentKeyWindow) _currentKeyWindow = [SBAlert shareManager].mainWindow;
    ...
    if (_currentKeyWindow) if (![SBAlert shareManager].mainWindow) [SBAlert shareManager].mainWindow = _currentKeyWindow;
...
@interface SBAlertViewController ()
...
@property (nonatomic , strong ) NSMutableArray <SBActionButton *>*alertActionArray;

@end

@implementation SBAlertViewController
{
...
- (CGFloat)updateAlertItemsLayout{
    ...
    [self.alertItemArray enumerateObjectsUsingBlock:^(id  _Nonnull item, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if ([item isKindOfClass:UIView.class]) {
            ...
            SBItemView *view = (SBItemView *)item;
        ...
        } else if ([item isKindOfClass:SBCustomView.class]) {
            
            SBCustomView *custom = (SBCustomView *)item;
            
            CGRect viewFrame = custom.container.frame;
            
            if (custom.isAutoWidth) {
                
                custom.positionType = SBCustomViewPositionTypeCenter;
    ...
    for (SBActionButton *button in self.alertActionArray) {
    ...
    if (self.alertActionArray.count == 2) {
        ...
        SBActionButton *buttonA = self.alertActionArray.count == self.config.modelActionArray.count ? self.alertActionArray.firstObject : self.alertActionArray.lastObject;
        
        SBActionButton *buttonB = self.alertActionArray.count == self.config.modelActionArray.count ? self.alertActionArray.lastObject : self.alertActionArray.firstObject;
...
- (void)configAlert{
    ...
    [self.config.modelItemArray enumerateObjectsUsingBlock:^(id _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        switch (item.type) {
            ...
            case SBItemTypeTitle:
            {
                void(^block)(UILabel *label) = item.block;
                
                SBItemLabel *label = [SBItemLabel label];
            ...
            case SBItemTypeCustomView:
            {
                void(^block)(SBCustomView *) = item.block;
                
                SBCustomView *custom = [[SBCustomView alloc] init];
            ...
            case SBItemTypeTextField:
            {
                SBItemTextField *textField = [SBItemTextField textField];
    ...
    [self.config.modelActionArray enumerateObjectsUsingBlock:^(id item, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        void (^block)(SBAction *action) = item;
        
        SBAction *action = [[SBAction alloc] init];
        ...
        if (!action.borderPosition) action.borderPosition = (self.config.modelActionArray.count == 2 && idx == 0) ? SBActionBorderPositionTop | SBActionBorderPositionRight : SBActionBorderPositionTop;
        
        if (!action.height) action.height = 45.0f;
        
        SBActionButton *button = [SBActionButton button];
...
- (void)buttonAction:(SBActionButton *)sender{
    ...
    switch (sender.action.type) {
        ...
        case SBActionTypeDefault:
            
            isClose = sender.action.isClickNotClose ? NO : YES;
            
            break;
            
        case SBActionTypeCancel:
            
            isClose = YES;
            
            break;
            
        case SBActionTypeDestructive:
...
- (void)showAnimationsWithCompletionBlock:(void (^)(void))completionBlock{
    ...
    if (self.config.modelOpenAnimationStyle & SBAnimationStyleOrientationNone) {
    ...
    } else if (self.config.modelOpenAnimationStyle & SBAnimationStyleOrientationTop) {
        
        containerFrame.origin.x = (viewWidth - containerFrame.size.width) * 0.5f;
        
        containerFrame.origin.y = 0 - containerFrame.size.height;
        
    } else if (self.config.modelOpenAnimationStyle & SBAnimationStyleOrientationBottom) {
        
        containerFrame.origin.x = (viewWidth - containerFrame.size.width) * 0.5f;
        
        containerFrame.origin.y = viewHeight;
        
    } else if (self.config.modelOpenAnimationStyle & SBAnimationStyleOrientationLeft) {
        
        containerFrame.origin.x = 0 - containerFrame.size.width;
        
        containerFrame.origin.y = (viewHeight - containerFrame.size.height) * 0.5f;
        
    } else if (self.config.modelOpenAnimationStyle & SBAnimationStyleOrientationRight) {
    ...
    if (self.config.modelOpenAnimationStyle & SBAnimationStyleFade) self.containerView.alpha = 0.0f;
    
    if (self.config.modelOpenAnimationStyle & SBAnimationStyleZoomEnlarge) self.containerView.transform = CGAffineTransformMakeScale(0.6f , 0.6f);
    
    if (self.config.modelOpenAnimationStyle & SBAnimationStyleZoomShrink) self.containerView.transform = CGAffineTransformMakeScale(1.2f , 1.2f);
    ...
    if (self.config.modelOpenAnimationConfigBlock) self.config.modelOpenAnimationConfigBlock(^{
        ...
        if (weakSelf.config.modelBackgroundStyle == SBBackgroundStyleTranslucent) {
        ...
        } else if (weakSelf.config.modelBackgroundStyle == SBBackgroundStyleBlur) {
...
- (void)closeAnimationsWithCompletionBlock:(void (^)(void))completionBlock{
    ...
    if (self.config.modelCloseAnimationConfigBlock) self.config.modelCloseAnimationConfigBlock(^{
        ...
        if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleOrientationNone) {
            
            containerFrame.origin.x = (viewWidth - containerFrame.size.width) * 0.5f;
            
            containerFrame.origin.y = (viewHeight - containerFrame.size.height) * 0.5f;
            
        } else if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleOrientationTop) {
            
            containerFrame.origin.x = (viewWidth - containerFrame.size.width) * 0.5f;
            
            containerFrame.origin.y = 0 - containerFrame.size.height;
            
        } else if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleOrientationBottom) {
            
            containerFrame.origin.x = (viewWidth - containerFrame.size.width) * 0.5f;
            
            containerFrame.origin.y = viewHeight;
            
        } else if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleOrientationLeft) {
            
            containerFrame.origin.x = 0 - containerFrame.size.width;
            
            containerFrame.origin.y = (viewHeight - containerFrame.size.height) * 0.5f;
            
        } else if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleOrientationRight) {
        ...
        if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleFade) weakSelf.containerView.alpha = 0.0f;
        
        if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleZoomEnlarge) weakSelf.containerView.transform = CGAffineTransformMakeScale(1.2f , 1.2f);
        
        if (weakSelf.config.modelCloseAnimationStyle & SBAnimationStyleZoomShrink) weakSelf.containerView.transform = CGAffineTransformMakeScale(0.6f , 0.6f);
...
- (NSMutableArray <SBActionButton *>*)alertActionArray{
...
@interface SBActionSheetViewController ()
...
@property (nonatomic , strong ) NSMutableArray <SBActionButton *>*actionSheetActionArray;

@property (nonatomic , strong ) UIView *actionSheetCancelActionSpaceView;

@property (nonatomic , strong ) SBActionButton *actionSheetCancelAction;

@end

@implementation SBActionSheetViewController
{
    BOOL isShowed;
}
...
- (void)updateActionSheetLayoutWithViewWidth:(CGFloat)viewWidth ViewHeight:(CGFloat)viewHeight{
    ...
    for (SBActionButton *button in self.actionSheetActionArray) {
...
- (void)configActionSheet{
    ...
    for (id item in self.config.modelActionArray) {
        ...
        switch (action.type) {
            ...
            default:
            {
                if (!action.borderPosition) action.borderPosition = SBActionBorderPositionTop;
...
- (void)showAnimationsWithCompletionBlock:(void (^)(void))completionBlock{
    ...
    if (self.config.modelOpenAnimationConfigBlock) self.config.modelOpenAnimationConfigBlock(^{
        ...
        switch (weakSelf.config.modelBackgroundStyle) {
            ...
            case SBBackgroundStyleBlur:
            {
                weakSelf.backgroundVisualEffectView.effect = [UIBlurEffect effectWithStyle:weakSelf.config.modelBackgroundBlurEffectStyle];
            }
                break;
                
            case SBBackgroundStyleTranslucent:
            {
...
- (NSMutableArray <SBActionButton *>*)actionSheetActionArray{
...
@interface SBAlertConfig ()<SBAlertProtocol>

@end

@implementation SBAlertConfig
    ...
    if (self) {
        ...
        self.config.modelFinishConfig = ^{
            ...
            if ([SBAlert shareManager].queueArray.count) {
                ...
                SBAlertConfig *last = [SBAlert shareManager].queueArray.lastObject;
                
                if (!strongSelf.config.modelIsQueue && last.config.modelQueuePriority > strongSelf.config.modelQueuePriority) return;
                
                if (!last.config.modelIsQueue && last.config.modelQueuePriority <= strongSelf.config.modelQueuePriority) [[SBAlert shareManager].queueArray removeObject:last];
                
                if (![[SBAlert shareManager].queueArray containsObject:strongSelf]) {
                    
                    [[SBAlert shareManager].queueArray addObject:strongSelf];
                    
                    [[SBAlert shareManager].queueArray sortUsingComparator:^NSComparisonResult(SBAlertConfig *configA, SBAlertConfig *configB) {
                ...
                if ([SBAlert shareManager].queueArray.lastObject == strongSelf) [strongSelf show];
...
- (void)setType:(SBAlertType)type{
    ...
    switch (type) {
        ...
        case SBAlertTypeAlert:
        
            self.config
            .sbConfigMaxWidth(^CGFloat(SBScreenOrientationType type) {
            
                return 280.0f;
            })
            .sbConfigMaxHeight(^CGFloat(SBScreenOrientationType type) {
            
                return SCREEN_HEIGHT - 40.0f - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).top - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).bottom;
            })
            .sbOpenAnimationStyle(SBAnimationStyleOrientationNone | SBAnimationStyleFade | SBAnimationStyleZoomEnlarge)
            .sbCloseAnimationStyle(SBAnimationStyleOrientationNone | SBAnimationStyleFade | SBAnimationStyleZoomShrink);
        
            break;
            
        case SBAlertTypeActionSheet:
            
        self.config
            .sbConfigMaxWidth(^CGFloat(SBScreenOrientationType type) {
                
                return type == SBScreenOrientationTypeHorizontal ? SCREEN_HEIGHT - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).top - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).bottom - 20.0f : SCREEN_WIDTH - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).left - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).right - 20.0f;
            })
            .sbConfigMaxHeight(^CGFloat(SBScreenOrientationType type) {
                
                return SCREEN_HEIGHT - 40.0f - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).top - VIEWSAFEAREAINSETS([SBAlert getAlertWindow]).bottom;
            })
            .sbOpenAnimationStyle(SBAnimationStyleOrientationBottom)
            .sbCloseAnimationStyle(SBAnimationStyleOrientationBottom);
...
- (void)show{
    ...
    switch (self.type) {
        ...
        case SBAlertTypeAlert:
            ...
            [SBAlert shareManager].viewController = [[SBAlertViewController alloc] init];
            
            break;
            
        case SBAlertTypeActionSheet:
        
            [SBAlert shareManager].viewController = [[SBActionSheetViewController alloc] init];
    ...
    if (![SBAlert shareManager].viewController) return;
    
    [SBAlert shareManager].viewController.config = self.config;
    
    [SBAlert shareManager].sbWindow.rootViewController = [SBAlert shareManager].viewController;
    
    [SBAlert shareManager].sbWindow.windowLevel = self.config.modelWindowLevel;
    
    [SBAlert shareManager].sbWindow.hidden = NO;
    
    [[SBAlert shareManager].sbWindow makeKeyAndVisible];
    
    __weak typeof(self) weakSelf = self;
    
    [SBAlert shareManager].viewController.openFinishBlock = ^{
        
    };
    
    [SBAlert shareManager].viewController.closeFinishBlock = ^{
        
        __strong typeof(weakSelf) strongSelf = weakSelf;
        
        if (!strongSelf) return;
        
        if ([SBAlert shareManager].queueArray.lastObject == strongSelf) {
            
            [SBAlert shareManager].sbWindow.hidden = YES;
            
            [SBAlert shareManager].sbWindow.rootViewController = nil;
            
            [SBAlert shareManager].sbWindow = nil;
            
            [SBAlert shareManager].viewController = nil;
            
            [[SBAlert shareManager].queueArray removeObject:strongSelf];
            
            if (strongSelf.config.modelIsContinueQueueDisplay) [SBAlert continueQueueDisplay];
...
- (void)closeWithCompletionBlock:(void (^)(void))completionBlock{
    ...
    if ([SBAlert shareManager].viewController) [[SBAlert shareManager].viewController closeAnimationsWithCompletionBlock:completionBlock];
}

#pragma mark - LazyLoading

- (SBAlertConfigModel *)config{
    
    if (!_config) _config = [[SBAlertConfigModel alloc] init];
