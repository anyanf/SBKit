...
/** 装饰view数组 */
@property (nonatomic, strong) NSMutableDictionary<NSIndexPath *, SBCollectionViewLayoutAttributes *> *decorationAttrDic;
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForDecorationViewOfKind:(NSString *)elementKind
    ...
    SBCollectionViewLayoutAttributes *attributes = [self.decorationAttrDic objectForKey:indexPath];
    
    if (!attributes) {
        attributes = [SBCollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:elementKind withIndexPath:indexPath];
        [self.decorationAttrDic setObject:attributes forKey:indexPath];
    }
...
- (NSMutableDictionary<NSIndexPath *, SBCollectionViewLayoutAttributes *> *)decorationAttrDic {
    if (!_decorationAttrDic) {
        _decorationAttrDic = [NSMutableDictionary dictionary];
    }
    return _decorationAttrDic;
}
